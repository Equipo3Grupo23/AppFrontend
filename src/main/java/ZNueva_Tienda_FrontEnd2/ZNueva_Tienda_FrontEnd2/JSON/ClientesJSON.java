...
public class ClientesJSON {
	...
	public static ArrayList<Clientes> parsingClientes(String json)
	...
	public static int postJSON(Clientes cliente) throws IOException {
		...
		String data = "{" + "\"cedula_cliente\":\"" + cliente.getCedula_cliente() + "\",\"email_cliente\": \""
				+ cliente.getEmail_cliente() + "\",\"nombre_cliente\": \"" + cliente.getNombre_cliente()
				+ "\",\"direccion_cliente\":\"" + cliente.getDireccion_cliente() + "\",\"telefono_cliente\":\"" + cliente.getTelefono_cliente() + "\"}";
	...
	public static ArrayList<Clientes> getJSONbuscar(long cedula) throws IOException, ParseException,
	org.apache.tomcat.util.json.ParseException, org.json.simple.parser.ParseException {
