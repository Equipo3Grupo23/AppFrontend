...
public class TestJSON {
	...
	public static ArrayList<Usuarios> parsingUsuarios(String json)
	...
	public static ArrayList<Usuarios> getJSONauth() throws IOException, ParseException,
	org.apache.tomcat.util.json.ParseException, org.json.simple.parser.ParseException {

url = new URL(sitio + "usuarios/auth");
HttpURLConnection http = (HttpURLConnection) url.openConnection();
http.setRequestMethod("GET");
http.setRequestProperty("Accept", "application/json");
InputStream respuesta = http.getInputStream();
...
return lista;
	...
	public static ArrayList<Usuarios> getJSONced() throws IOException, ParseException,
	org.apache.tomcat.util.json.ParseException, org.json.simple.parser.ParseException {

url = new URL(sitio + "usuarios/buscar/{cedula_usuario}");
HttpURLConnection http = (HttpURLConnection) url.openConnection();
http.setRequestMethod("GET");
http.setRequestProperty("Accept", "application/json");
InputStream respuesta = http.getInputStream();
