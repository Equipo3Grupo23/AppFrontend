...
<div class="col-sm-10">      
<input type="text" class="form-control" id="inputEmail3" name="nit">    
</div>  
</div>

<div class="form-group row">    
<label for="inputEmail3" class="col-sm-2 col-form-label">Nombre proveedor</label>    
<div class="col-sm-10">      
<input type="text" class="form-control" id="inputEmail3" name="nombre">    
</div>  
</div>
...
<div class="col-sm-10">      
<input type="text" class="form-control" id="inputEmail3" name="telefono">    
</div>  
</div>
...
<div class="col-sm-10">      
<input type="text" class="form-control" id="inputPassword3" name="direccion">    
</div>  
</div>  
...
<div class="col-sm-10">      
<input type="text" class="form-control" id="inputEmail3" name="ciudad">    
</div>  
</div>
</div>
 </div>
...
<button type="submit" class="btn btn-primary btn-lg" value="agregar" name="tipo">Agregar</button>    

<button type="submit" class="btn btn-primary btn-lg" value="borrar" name="tipo">Borrar</button>    
</div>  
</div>
</div>
</form>
...
<input type="text" class="form-control" name="txtnit" placeholder="Nit" aria-label="Nit" aria-describedby="basic-addon2">   
