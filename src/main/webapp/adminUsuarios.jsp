...
<div class="col-sm-10">      
<input type="text" class="form-control" id="inputEmail3" name="cedula">    
</div>  
</div>
...
<input type="text" class="form-control" name="txtcedula" placeholder="Cedula" aria-label="Cedula" aria-describedby="basic-addon2">   
